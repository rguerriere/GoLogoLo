...
import static golo.goloPropertyType.GOLO_TEXT_SIZE_DOWN_BUTTON;
import static golo.goloPropertyType.GOLO_TEXT_SIZE_UP_BUTTON;
...
public class goloFoolproofDesign implements FoolproofDesign {
    ...
    public void updateControls() {
        ...
        if(itemIsSelected == true || itemsAreSelected == true){
            ...
            gui.getGUINode(GOLO_TEXT_SIZE_DOWN_BUTTON).setDisable(!(selectedComponent instanceof Text));
