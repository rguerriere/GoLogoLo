...
public enum AppPropertyType {
    ...
    GENERAL_ERROR_TITLE, GENERAL_ERROR_CONTENT,
    CORRUPTED_FILE_TITLE, CORRUPTED_FILE_CONTENT,
    MISSING_DATA_TITLE, MISSING_DATA_CONTENT,
    GOLO_CANVAS_PANE,
    ...
    HAS_WELCOME_DIALOG,
    HAS_TOP_TOOLBAR,
    HAS_FILE_TOOLBAR, HAS_CLIPBOARD_TOOLBAR, HAS_UNDO_TOOLBAR, HAS_HELP_TOOLBAR,HAS_VIEWPORT_TOOLBAR,
    HAS_NEW, HAS_LOAD, HAS_CLOSE, HAS_SAVE, HAS_EXPORT, HAS_EXIT,
    HAS_HELP, HAS_LANGUAGE, HAS_ABOUT, HAS_HOME, HAS_ZOOM_IN, HAS_ZOOM_OUT, HAS_RESIZE,HAS_SNAP,
    ...
    HOME_BUTTON, ZOOM_IN_BUTTON, ZOOM_OUT_BUTTON, RESIZE_BUTTON,
    SNAP_CHECKBOX,
    ...
    ADD_TEXT_TITLE,   ADD_TEXT_CONTENT,
    EDIT_TEXT_TITLE, EDIT_TEXT_CONTENT,
