...
import static djf.AppPropertyType.CORRUPTED_FILE_CONTENT;
import static djf.AppPropertyType.CORRUPTED_FILE_TITLE;
...
public class AppFileModule {
    ...
    public void loadWork(File selectedFile) throws IOException {
        ...
        catch(Exception e)
        {
            ...
            AppDialogsFacade.showMessageDialog(app.getGUIModule().getWindow(), CORRUPTED_FILE_TITLE, CORRUPTED_FILE_CONTENT);
